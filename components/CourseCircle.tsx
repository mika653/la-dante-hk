...
export default function CourseCircle({ label, tag, href, tone, icon }: Props) {
  return (
    <Link href={href} className="group flex flex-col items-center text-center">
      ...
      <p className="eyebrow mt-4 !text-ink-muted group-hover:!text-azzurro">{tag}</p>
      <h3 className="mt-1.5 text-lg md:text-xl font-semibold inline-flex items-center gap-1.5 group-hover:text-azzurro">
