    ...
    <section className="bg-ink text-cream py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="container-xl relative z-10">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <blockquote className="mt-6 text-2xl md:text-3xl font-heading font-semibold leading-[1.2]">
            “{t.quote}”
          </blockquote>
          <p className="mt-6 text-[15px] text-cream/80">
            <span className="font-medium text-cream">{t.name}</span> · {t.level} · {t.year}
          </p>
