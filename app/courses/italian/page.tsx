  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Knowledge of another culture broadens your horizons and changes you in a profound way. Italian language and culture are not exceptions and learning them can enrich your personal, professional, and cultural experiences. Check out the seven reasons why you should embark yourself on such an amazing learning experience."
      ...
      <section className="bg-cream py-14 md:py-16 border-t border-line">
        <div className="container-xl max-w-3xl">
          <p className="eyebrow">Why learning Italian at La Dante?</p>
