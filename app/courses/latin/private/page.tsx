      ...
      <section className="bg-white py-14 md:py-20">
        <div className="container-xl max-w-2xl">
          <div className="mb-8 space-y-1.5 text-[15px] leading-relaxed">
            <p>Choose flexible time and schedule, in person or online via Zoom.</p>
            ...
            <p className="pt-2 text-[13px] text-ink-muted">私人課堂：可根據你的日程安排進行規劃。你可選擇親臨但丁協會，或通過網上授課(Zoom)。如需更改上課時間或地點，請提前24小時通知我們。</p>
            <p className="text-[13px] text-ink-muted">如欲了解更多課程資訊，請填寫以下表格，或致電 2832 9799 聯絡我們。</p>
          </div>
