...
export default function LatinGroupsPage() {
  return (
    <>
      <PageHeader
        eyebrow="Latin · Groups"
        ...
        crumbs={[{ label: "Home", href: "/" }, { label: "Courses", href: "/courses" }, { label: "Latin", href: "/courses/latin" }, { label: "Groups" }]}
        tone="sole-soft"
      />
