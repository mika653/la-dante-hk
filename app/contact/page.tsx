        ...
        <div className="container-xl grid md:grid-cols-2 gap-10">
          <div className="space-y-5">
            ...
            <div className="frame p-6 bg-white flex gap-4"><Phone size={22} className="text-azzurro-deep shrink-0" aria-hidden />
              <div><p className="font-semibold">Phone</p><a href="tel:+85228529788" className="text-sm text-ink-muted hover:text-azzurro-deep">+852 2852 9788</a></div>
            </div>
            <div className="frame p-6 bg-white flex gap-4"><Mail size={22} className="text-azzurro-deep shrink-0" aria-hidden />
              <div><p className="font-semibold">Email</p><a href="mailto:info@ladante.cc" className="text-sm text-ink-muted hover:text-azzurro-deep">info@ladante.cc</a></div>
            </div>
