...
const en = {
  ...
  daily: {
    ...
    phrase: "Phrase of the week",
    footer: "A new one every week.",
  },
  featured: {
  ...
  footer: {
    ...
    newsletterBlurb: "Italian culture in your inbox — news, events, and new courses.",
    subscribe: "Subscribe",
    whatsapp: "WhatsApp",
    courses: "Courses",
...
const zh: typeof en = {
  ...
  footer: {
    ...
    explore: "探索",
    newsletter: "電子報",
    newsletterBlurb: "意大利文化直送信箱 — 最新消息、活動與課程。",
    subscribe: "訂閱",
    whatsapp: "WhatsApp",
    courses: "課程",
    badWeather: "惡劣天氣安排",
